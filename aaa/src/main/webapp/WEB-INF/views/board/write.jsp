      ...
      <form action="write" method="POST" id="frm"'>
         <div class="container">
            <div class="row mx-0 mb-4 form-inline"> 
               ...
               <input type="text" class="form-control form-control-lg w-75" name="title" id="title" placeholder="제목">
            </div>
            ...
            <div class="my-3 pull-right">
               ...
               <input type="button" value="등록" style="width: 100px" class="btn btn-info btn-lg active" onclick="btn_insert();"> 
               <input type="button" value="취소" style="width: 100px" class="btn btn-info btn-lg active" onclick="">
            </div>
         </div>
      </form>
   </div>
